...
const surfaceOptions: Array<{
...
}> = [
  {
    ...
    label: "运行详情",
    eyebrow: "完整转录",
    description: "长篇运行页面，带 `Nice | Raw` 切换，提供最可审查的转录视图。",
    icon: MonitorCog,
  },
  {
    id: "live",
    label: "任务组件",
    eyebrow: "实时流",
    description: "任务详情页中的实时运行组件，便于不离开任务页面跟踪活跃运行。",
    icon: RadioTower,
  },
  {
    id: "dashboard",
    label: "仪表盘卡片",
    eyebrow: "高密卡片",
    description: "活跃智能体仪表盘卡片，在紧凑浏览下保持与其他视图一致的转录语言。",
    icon: PanelsTopLeft,
  },
];
          ...
          <aside className="border-b border-border/60 bg-background/75 p-5 lg:border-b-0 lg:border-r">
            <div className="mb-5">
              ...
              <p className="mt-2 text-sm text-muted-foreground">
                来源于一次真实 Paperclip 开发运行，并已脱敏，确保不包含密钥、本地路径或环境细节。
              </p>
            </div>
            ...
            <div className="mb-5 flex flex-col gap-4 xl:flex-row xl:items-end xl:justify-between">
              ...
              <div className="flex flex-wrap items-center gap-2">
                <Badge variant="outline" className="rounded-full px-3 py-1 text-[10px] uppercase tracking-[0.18em]">
                  源运行 {runTranscriptFixtureMeta.sourceRunId.slice(0, 8)}
                </Badge>
                <Badge variant="outline" className="rounded-full px-3 py-1 text-[10px] uppercase tracking-[0.18em]">
